...
public final class QualificationDynamicSqlSupport {
    ...
    public static final SqlColumn<String> qualificationPersonId = QUALIFICATION_TABLE.qualificationPersonId;
public static final SqlColumn<String> documentQualificationId = QUALIFICATION_TABLE.documentQualificationId;
    ...
    public static final class QualificationTable extends SqlTable{
        ...
        public final SqlColumn<String> qualificationPersonId = column("person_id", JDBCType.LONGNVARCHAR);
        public final SqlColumn<String> documentQualificationId = column("document_id", JDBCType.LONGNVARCHAR);
