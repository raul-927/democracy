...
public interface CityNeighDynamicMapper {
    ...
    default Mono<Long> count(CountDSLCompleter completer) {
        return ReactiveMyBatis3Utils.countFrom(this::counter, cityNeighTable, completer);
    }

    default Mono<Integer> delete(DeleteDSLCompleter completer) {
        return ReactiveMyBatis3Utils.deleteFrom(this::delete, cityNeighTable, completer);
    }

    default Mono<CityNeighborhood> selectOne(SelectDSLCompleter completer) {
        return ReactiveMyBatis3Utils.selectOne(this::selectOne, cityNeighColumns, cityNeighTable, completer);
    }

    default Flux<CityNeighborhood> select(SelectDSLCompleter completer) {
        return ReactiveMyBatis3Utils.selectList(this::selectMany, cityNeighColumns, cityNeighTable, completer);
    }


    default Flux<CityNeighborhood> selectDistinct(SelectDSLCompleter completer) {
        return ReactiveMyBatis3Utils.selectDistinct(this::selectMany, cityNeighColumns, cityNeighTable, completer);
    }

    default Mono<Integer> update(UpdateDSLCompleter completer) {
        return ReactiveMyBatis3Utils.update(this::update, cityNeighTable, completer);
    }
