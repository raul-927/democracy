package com.democracy.electoral_court.infrastructure.constants;

public class RouterConstant {
    //--------------------GENERIC PATH---------------------------------
    public static final String PATH_MAIN = "/electoralcourt";
    ...
    //--------------------DOMAIN PATH---------------------------------------
    public static final String INVESTIGATION_PATH = "/investigation";
