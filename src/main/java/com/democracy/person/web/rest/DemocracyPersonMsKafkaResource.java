...
@RestController
@RequestMapping("/api/democracy-person-ms-kafka")
public class DemocracyPersonMsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DemocracyPersonMsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DemocracyPersonMsKafkaResource(KafkaProperties kafkaProperties) {
